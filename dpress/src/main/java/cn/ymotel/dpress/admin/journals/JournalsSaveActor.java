...
@ActorCfg(urlPatterns = "/api/admin/journals/{id}",methods = RequestMethod.PUT)
public class JournalsSaveActor implements Actor<ServletMessage> {
    @Autowired
    ...
    public Map Execute(ServletMessage message) throws Throwable {
        ...
        sqlSession.update("journals.u",map);
        return new HashMap();
    }
}
