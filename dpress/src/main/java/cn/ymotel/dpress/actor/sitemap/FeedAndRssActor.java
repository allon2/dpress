...
@ActorCfg(urlPatterns = {"/feed", "/feed.xml", "/rss", "/rss.xml"},chain = "publicchain" )
public class FeedAndRssActor  extends FreemarkerActor {
        @Autowired
    ...
    public ViewData Execute(ServletMessage message) throws Throwable {
       ...
       for(int i=0;i<posts.size();i++){
        ...
        viewData.setViewName("common/web/rss");
