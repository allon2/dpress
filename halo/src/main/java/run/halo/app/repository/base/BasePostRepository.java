...
public interface BasePostRepository<POST extends BasePost> extends BaseRepository<POST, Integer> {
     ...
     */
    @NonNull
    Page<POST> findAllByStatusAndSiteid(@NonNull PostStatus status,Object siteid, @NonNull Pageable pageable);
     ...
     */
    Optional<POST> getBySlugAndSiteid(@NonNull String slug,Object siteid);
